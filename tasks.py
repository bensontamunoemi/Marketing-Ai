...
class MarketingAnalysisTasks:
    def product_analysis(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="A detailed report highlighting the product's unique features, benefits, market appeal, and suggestions for improvement."
        )
    ...
    def competitor_analysis(self, agent, product_website, product_details):
        return Task(
            ...
            """),
            agent=agent,
            expected_output="A comparative analysis report of the top 3 competitors, their strategies, market positioning, and customer perception."
        )
    ...
    def campaign_development(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="A strategic marketing campaign outline with creative content ideas that align with the product and customer context."
        )
    ...
    def instagram_ad_copy(self, agent):
        return Task(
            description=dedent("""\
                ...
                """),
            agent=agent,
            expected_output="Three engaging and persuasive Instagram ad copy options that align with the product's marketing strategy."
        )
    ...
    def take_photograph_task(self, agent, copy, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Three creative photograph descriptions that align with the campaign and engage the audience."
        )
    ...
    def review_photo(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Three reviewed photograph descriptions with feedback or approval for the campaign."
        )
